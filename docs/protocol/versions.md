...
| Enum constant | Protocol | Version string | Notable changes |
|---|---|---|---|
| `MINECRAFT_1_7_2` | 4 | 1.7.2 | Baseline — oldest supported |
| `MINECRAFT_1_7_10` | 5 | 1.7.10 | |
| `MINECRAFT_1_8` | 47 | 1.8 | Chat signing introduced |
| `MINECRAFT_1_9` | 107 | 1.9 | Off-hand slot; elytra |
...
| `MINECRAFT_1_13` | 393 | 1.13 | Chat/command changes |
...
| `MINECRAFT_1_19` | 759 | 1.19 | Chat signing; player reports |
| `MINECRAFT_1_19_1` | 760 | 1.19.1/1.19.2 | |
| `MINECRAFT_1_19_3` | 761 | 1.19.3 | LoginStart UUID field added |
| `MINECRAFT_1_19_4` | 762 | 1.19.4 | |
| `MINECRAFT_1_20` | 763 | 1.20/1.20.1 | |
| `MINECRAFT_1_20_2` | 764 | 1.20.2 | **Configuration phase** added; LoginAcknowledged required |
