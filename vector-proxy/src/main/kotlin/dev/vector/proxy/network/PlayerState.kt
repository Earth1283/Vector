...
sealed class PlayerState {
    ...
    fun transition(next: PlayerState): PlayerState {
        val allowed = when (this) {
            ...
            is Authenticating -> next is InServer || next is Limbo || next is Disconnecting
            is Limbo         -> next is InServer || next is Disconnecting
            is InServer      -> next is InServer || next is Limbo || next is Disconnecting
